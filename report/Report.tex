...
\begin{document}
  ...
  are considered. This will make the approximation more robust to variations in image content. \\
  ...
  applying another central difference using $\Delta y$
  \begin{center}
    \begin{tabular}{l}
      \vspace{12pt}
      $I_{xy}(x,y,t) = \frac{I(x+\Delta x,y,t) - 2I(x,y,t) + I(x-\Delta x,y,t)}{\Delta x^{2}}$\\
    \end{tabular}
  \end{center}
  \vspace{12pt}
