...
\begin{document}
  ...
  \noindent 
  In its base configuration, we see that the sigmoidal penalty is able to still
  ...
  \noindent
  It is extremely intersting to see how the MSE associated with the
  ...
  \noindent
  As a result, we again see the MSE associated with the sigmoidal
  ...
  \begin{table}[h]
    ...
    1           &  93.74          & \multicolumn{2}{l|}{88.87}            & \multicolumn{5}{l|}{248.36}          \\ \hline
