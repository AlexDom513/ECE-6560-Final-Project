...
\begin{document}
  ...
  testing the custom PDE.
    \begin{table}[h]
      ...
      1           &  $\Delta t = 0.05 $    & \multicolumn{1}{l|}{$\Delta t =$} \ $\epsilon =$  &    & \multicolumn{1}{l|}{$\Delta t =$} & \multicolumn{1}{l|}{$\epsilon =$} & \multicolumn{1}{l|}{$\lambda = 1$} & \multicolumn{1}{l|}{$\beta = 4$} & $c= 0$ \\ \hline
      2           &  $\Delta t = 0.05 $    & \multicolumn{1}{l|}{$\Delta t =$} \ $\epsilon =$  &    & \multicolumn{1}{l|}{$\Delta t =$} & \multicolumn{1}{l|}{$\epsilon =$} & \multicolumn{1}{l|}{$\lambda = 1$} & \multicolumn{1}{l|}{$\beta = 4$} & $c= 0$ \\ \hline
      3           &  $\Delta t = 0.05 $    & \multicolumn{1}{l|}{$\Delta t =$} \ $\epsilon =$  &    & \multicolumn{1}{l|}{$\Delta t =$} & \multicolumn{1}{l|}{$\epsilon =$} & \multicolumn{1}{l|}{$\lambda = 1$} & \multicolumn{1}{l|}{$\beta = 4$} & $c= 0$ \\ \hline
      4           &  $\Delta t = 0.05 $    & \multicolumn{1}{l|}{$\Delta t =$} \ $\epsilon =$  &    & \multicolumn{1}{l|}{$\Delta t =$} & \multicolumn{1}{l|}{$\epsilon =$} & \multicolumn{1}{l|}{$\lambda = 1$} & \multicolumn{1}{l|}{$\beta = 4$} & $c= 0$ \\ \hline
      \end{tabular}
    \end{table}
  ...
  All results were generated by running Evaluation.py script.

  \begin{enumerate}
    \item \textbf{Baseline Smoothing}\\
      Custom PDE parameters all set to one or zero to use penalty associated with typical sigmoid
      \includegraphics[scale=0.1]{../report_images/baseline_smoothing.png}

    \newpage
    \item \textbf{Linear Smoothing}\\
      Custom PDE slope matching linear penalty for range 10 to 75
    \includegraphics[scale=0.1]{../report_images/linear_smoothing.png}

    \newpage
    \item \textbf{Aggressive Smoothing}\\
