...
\begin{document}
  ...
  \begin{enumerate}
    \item \textbf{Baseline Smoothing}\\
      \begin{tabular}{l}
        \vspace{12pt}
        Custom PDE parameters all set to one or zero to use penalty associated with a typical sigmoid.\\
        \vspace{12pt}
        \includegraphics[scale=0.15]{../report_images/baseline_smoothing.png}
      \end{tabular}
